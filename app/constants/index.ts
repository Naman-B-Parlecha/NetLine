...
export const NetworkDeviceMonitor = [
    {
        monitor: "VCD-ROU-01MKSGCAUA-LOC",
        status: "up",
        ip: "192.168.212.2",
        type: "router",
        group: "Network > VPN > FL",
        osVersion: "Cisco IOS Software [Bengaluru]",
        systemDescription: "C9200-24T-4G",
        model: "C9200-24T-4G",
    },
    {
        monitor: "IMN-ROU-02HKSGN-LOC",
        status: "up",
        ip: "192.168.210.4",
        type: "router",
        group: "Network > HongKong",
        osVersion: "Cisco IOS Software [Everest]",
        systemDescription: "ISR4331/K9",
        model: "ISR4331/K9",
    },
    {
        monitor: "ATL-ROU-02HCHDB-LOCAL",
        status: "unreachable",
        ip: "192.168.102.1",
        type: "router",
        group: "Network > ATL",
        osVersion: "Cisco IOS Software [Gibraltar]",
        systemDescription: "ASR1001-X",
        model: "ASR1001-X",
    },
    {
        monitor: "JPN-ROU-01TOKYO",
        status: "up",
        ip: "10.0.1.1",
        type: "router",
        group: "Network > VPN > JP",
        osVersion: "Cisco IOS Software [Fuji]",
        systemDescription: "C9200L-48P-4X",
        model: "C9200L-48P-4X",
    },
    {
        monitor: "USW-ROU-01NYC",
        status: "up",
        ip: "10.1.2.1",
        type: "router",
        group: "Network > Data Center > NYC",
        osVersion: "Cisco IOS Software [Bengaluru]",
        systemDescription: "ISR4351/K9",
        model: "ISR4351/K9",
    },
    {
        monitor: "FRA-ROU-01GER",
        status: "down",
        ip: "192.168.10.20",
        type: "router",
        group: "Network > EU > Germany",
        osVersion: "Cisco IOS Software [Dublin]",
        systemDescription: "ISR4431/K9",
        model: "ISR4431/K9",
    },
    {
        monitor: "SGP-ROU-02LOC",
        status: "up",
        ip: "192.168.202.11",
        type: "router",
        group: "Network > APAC > Singapore",
        osVersion: "Cisco IOS Software [Amsterdam]",
        systemDescription: "ASR1002-HX",
        model: "ASR1002-HX",
    },
    {
        monitor: "IND-ROU-03BLR",
        status: "up",
        ip: "10.10.10.1",
        type: "router",
        group: "Network > HQ > Bangalore",
        osVersion: "Cisco IOS Software [Bengaluru]",
        systemDescription: "ISR4321/K9",
        model: "ISR4321/K9",
    },
    {
        monitor: "LON-ROU-01UK",
        status: "unreachable",
        ip: "172.16.50.3",
        type: "router",
        group: "Network > UK > London",
        osVersion: "Cisco IOS Software [Everest]",
        systemDescription: "ISR4351/K9",
        model: "ISR4351/K9",
    },
    {
        monitor: "CAN-ROU-01TOR",
        status: "up",
        ip: "192.168.55.1",
        type: "router",
        group: "Network > CA > Toronto",
        osVersion: "Cisco IOS Software [Fuji]",
        systemDescription: "ASR1001-X",
        model: "ASR1001-X",
    },
    {
        monitor: "BRA-ROU-01RIO",
        status: "up",
        ip: "192.168.65.2",
        type: "router",
        group: "Network > South America > Brazil",
        osVersion: "Cisco IOS Software [Dublin]",
        systemDescription: "ISR4221/K9",
        model: "ISR4221/K9",
    },
    {
        monitor: "MEX-ROU-01MEX",
        status: "down",
        ip: "10.15.3.4",
        type: "router",
        group: "Network > North America > Mexico",
        osVersion: "Cisco IOS Software [Amsterdam]",
        systemDescription: "ISR4331/K9",
        model: "ISR4331/K9",
    },
    {
        monitor: "AUS-ROU-01SYD",
        status: "up",
        ip: "192.168.33.4",
        type: "router",
        group: "Network > Australia > Sydney",
        osVersion: "Cisco IOS Software [Bengaluru]",
        systemDescription: "ASR1002-HX",
        model: "ASR1002-HX",
    },
    {
        monitor: "SAF-ROU-01CPT",
        status: "up",
        ip: "10.12.6.7",
        type: "router",
        group: "Network > Africa > South Africa",
        osVersion: "Cisco IOS Software [Gibraltar]",
        systemDescription: "ISR4351/K9",
        model: "ISR4351/K9",
    },
    {
        monitor: "KOR-ROU-02SEO",
        status: "up",
        ip: "10.3.2.2",
        type: "router",
        group: "Network > APAC > South Korea",
        osVersion: "Cisco IOS Software [Everest]",
        systemDescription: "ISR4221/K9",
        model: "ISR4221/K9",
    },
    {
        monitor: "CHI-ROU-01BEI",
        status: "unreachable",
        ip: "172.16.10.10",
        type: "router",
        group: "Network > Asia > China",
        osVersion: "Cisco IOS Software [Amsterdam]",
        systemDescription: "ASR1002-HX",
        model: "ASR1002-HX",
    },
    {
        monitor: "RU-ROU-01MOS",
        status: "down",
        ip: "192.168.100.12",
        type: "router",
        group: "Network > Europe > Russia",
        osVersion: "Cisco IOS Software [Fuji]",
        systemDescription: "ISR4451-X/K9",
        model: "ISR4451-X/K9",
    },
    {
        monitor: "UAE-ROU-01DXB",
        status: "up",
        ip: "10.20.5.6",
        type: "router",
        group: "Network > Middle East > UAE",
        osVersion: "Cisco IOS Software [Dublin]",
        systemDescription: "ISR4321/K9",
        model: "ISR4321/K9",
    },
    {
        monitor: "EGY-ROU-01CPT",
        status: "up",
        ip: "192.168.99.5",
        type: "router",
        group: "Network > Africa > Egypt",
        osVersion: "Cisco IOS Software [Gibraltar]",
        systemDescription: "ISR4351/K9",
        model: "ISR4351/K9",
    },
    {
        monitor: "ARG-ROU-01BUE",
        status: "up",
        ip: "10.50.7.8",
        type: "router",
        group: "Network > South America > Argentina",
        osVersion: "Cisco IOS Software [Amsterdam]",
        systemDescription: "ASR1001-X",
        model: "ASR1001-X",
    },
